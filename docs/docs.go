                    ...
                    "200": {
                        ...
                        "schema": {
                            ...
                            "items": {
                                "type": "array",
                                "items": {
                                    "$ref": "#/definitions/api.SwaggerAccount"
                                }
                            }
                        }
                    }
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.SwaggerTransferResult"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "api.SwaggerTransferResult": {
            ...
            "properties": {
                ...
                "from_entry": {
                    "$ref": "#/definitions/api.SwaggerEntry"
                },
                "to_account": {
                    "$ref": "#/definitions/api.SwaggerAccount"
                },
                ...
                "transfer": {
                    "$ref": "#/definitions/api.SwaggerTransfer"
                }
            }
        },
