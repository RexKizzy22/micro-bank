...
// Source: github.com/Rexkizzy22/micro-bank/task (interfaces: TaskDistributor)
...
import (
	...
	task "github.com/Rexkizzy22/micro-bank/task"
...
func (m *MockTaskDistributor) DistributeTaskSendVerifyEmail(arg0 context.Context, arg1 *task.EmailVerificationPayload, arg2 ...asynq.Option) error {
	m.ctrl.T.Helper()
