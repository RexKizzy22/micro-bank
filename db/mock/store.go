...
// Source: github.com/Rexkizzy22/simple-bank/db/sqlc (interfaces: Store)
...
// DeleteTrasfer mocks base method.
func (m *MockStore) DeleteTrasfer(arg0 context.Context, arg1 int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteTrasfer", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteTrasfer indicates an expected call of DeleteTrasfer.
func (mr *MockStoreMockRecorder) DeleteTrasfer(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteTrasfer", reflect.TypeOf((*MockStore)(nil).DeleteTrasfer), arg0, arg1)
}
